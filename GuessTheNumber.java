...
public class GuessTheNumber {
    ...
    public static boolean findNumber(int round)
    {
        ...
        int attempt = 10;         //  Number of Attempt user can make
        int score = 100;          //  Maximum Score == 100
        boolean ans = false;      //  to store the result 
        ...
        if(attempt == 0){
            ...
            return false;        // if attempt == 0 then method findNumber will return false
        }

        return true;                   // if attempt != 0 and if ans is true then method findNumber will return true
    }
